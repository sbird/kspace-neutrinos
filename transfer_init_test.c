...
static void test_transfer_init(void **state) {
    ...
    allocate_transfer_init_table(&transfer, 1000000000, UnitLength_in_cm, UnitLength_in_cm*1e3, "testdata/ics_transfer_99.dat");
    ...
    allocate_transfer_init_table(&transfer, 512000, UnitLength_in_cm, UnitLength_in_cm*1e3, "testdata/ics_transfer_99.dat");
    ...
    allocate_transfer_init_table(&transfer2, 512, 1e3*UnitLength_in_cm, UnitLength_in_cm*1e3, "testdata/ics_transfer_99.dat");
