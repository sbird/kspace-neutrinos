...
static void test_transfer_init(void **state) {
    ...
    allocate_transfer_init_table(&transfer, 1000000000, UnitLength_in_cm, UnitLength_in_cm*1e3, 0.0463, 0.2793, 0.00986007458598642, "testdata/ics_transfer_99.dat");
    ...
    allocate_transfer_init_table(&transfer, 512000, UnitLength_in_cm, UnitLength_in_cm*1e3, 0.0463, 0.2793, 0.00986007458598642, "testdata/ics_transfer_99.dat");
    ...
    allocate_transfer_init_table(&transfer2, 512, 1e3*UnitLength_in_cm, UnitLength_in_cm*1e3, 0.0463, 0.2793, 0.00986007458598642, "testdata/ics_transfer_99.dat");
    ...
    assert_true(fabs(transfer.T_nu[0] - 0.50595906397224788) < 1e-6);
    assert_true(fabs(transfer.T_nu[30] - 0.010999617311520191) < 1e-6);
    free_transfer_init_table(&transfer);
